...
{
    class RoadCross : Tile
    {
        private Primitive roadNoSo { get { return primitives[1]; } set { primitives[1] = value; } }
        private Primitive roadEaWe { get { return primitives[2]; } set { primitives[2] = value; } }
        private Primitive lineNoSo { get { return primitives[3]; } set { primitives[3] = value; } }
        private Primitive lineEaWe { get { return primitives[4]; } set { primitives[4] = value; } }

        public RoadCross(Game g, BasicEffect b, Vector3 position, float tileSize, Color[] faces, Color[] wires) : base(g, b, position, tileSize, faces, wires) { }
        ...
        protected override void InitialiseBuilding()
        {
            ...
            roadEaWe = new PrismSquare(game, effect, vOrigin + roadRise, rY90, roadSize, FaceTone(2, 1), WireTone(3, 1), shadeMode, Primitive.Drawing.Face);
            lineNoSo = new Line(game, effect, vOrigin + roadRise, null, lineSize, WireTone(3, 2));
            lineEaWe = new Line(game, effect, vOrigin + roadRise, rY90, lineSize, WireTone(3, 2));
        }
