...
namespace Primitives
{
    ...
    abstract class Primitive
    {
        ...
        public bool Opaque { get { return opaque; } }
        ...
        Vector3 vScl, vPos, IvScl, IvPos;
        Quaternion qRot, IqRot;

        Matrix mWorld, mScl, mRot, mPos;
        ...
        public Matrix mRotation { get { return mRot; } set { mRot = value; } }
        public Matrix mTranslation { get { return mPos; } set { mPos = value; } }
        ...
        public Primitive(Game g, BasicEffect b, Vector3? position, Quaternion? preRot, Vector3 sizeXYZ, Color? face, Color? wire, Shading shade, Drawing draw)
        {
            ...
            Quaternion rot = preRot ?? Quaternion.Identity;
            IqRot = qRot = Quaternion.Normalize(rot);
        ...
        public void RotationResetX()
        {
            qRot.X = IqRot.X;
        }

        public void RotationResetY()
        {
            qRot.Y = IqRot.Y;
        }

        public void RotationResetZ()
        {
            qRot.Z = IqRot.Z;
        }

        public void RotationResetAll()
        {
            qRot = IqRot;
        }
        ...
        public void AddListScale()
        {
            mList.Add(Matrix.CreateScale(vScl));
        }

        public void AddListRotate()
        {
            mList.Add(Matrix.CreateFromQuaternion(qRot));
        }

        public void AddListTranslate()
        {
            mList.Add(Matrix.CreateTranslation(vPos));
        }
